const notebooks = [];
        ...
        function createActionsDropdown(notebookIndex) {
            ...
            addNoteButton.onclick = () => addNoteToNotebook(notebookIndex);
        ...
        function addNotebookRow(title, creator, updated, sharedWith) {
            ...
            row.dataset.notebookIndex = notebooks.length;

            const titleCell = document.createElement("td");
            titleCell.innerHTML = `
                <div style="display: flex; align-items: center; gap: 8px;">
                    <button class="collapse-btn" onclick="toggleNotes(${notebooks.length})">
            ...
            const actionsContainer = createActionsDropdown(notebooks.length);
            ...
            notebooks.push({ title, creator, updated, sharedWith, notes: [] });
            updateNotebookCount();
        }
